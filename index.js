...
app.get('/scan/:barcode', async (req, res) => {
  try {
    ...
    res.json({ productName, ingredients, nutriScore, novaGroup, additivesCount, isOrganic: isOrganic ? 'Yes' : 'No', protein, score, explanation, scoreColor, imageUrl, scoreLabel });
  } catch (err) {
