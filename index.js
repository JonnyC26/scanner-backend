...
app.get('/scan/:barcode', async (req, res) => {
  try {
    ...
    res.json({ productName, ingredients, nutriScore, novaGroup, additivesCount: additivesCount === 0 ? 'None' : additivesCount + ' additives', isOrganic: isOrganic ? 'Yes' : 'No', protein: protein + 'g', score, explanation, scoreColor, imageUrl, scoreLabel });
  } catch (err) {
